        ...
        <nav className="p-4 text-white flex justify-between h-[10vh] items-center px-10">
            ...
            <div className="flex items-center gap-5">
                ...
                <div>
                    {
                        visible
                            ? <IoCloseOutline onClick={() => setVisible(false)} size={24} className="text-neutral-300 block xl:hidden hover:cursor-pointer" />
                            : <GiHamburgerMenu onClick={() => setVisible(true)} size={24} className="text-neutral-300 block xl:hidden hover:cursor-pointer" />
                    }
